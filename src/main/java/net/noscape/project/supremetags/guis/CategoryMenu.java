...
public class CategoryMenu extends Paged {
    ...
    public String getMenuName() {
        return format(Objects.requireNonNull(SupremeTagsPremium.getInstance().getConfig().getString("categories." + menuUtil.getCategory() + ".title")).replaceAll("%page%", String.valueOf(this.getPage())));
    }
