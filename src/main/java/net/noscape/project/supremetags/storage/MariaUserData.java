...
public class MariaUserData {
    ...
    public boolean exists(Player player) {
        try {
            PreparedStatement statement = SupremeTags.getMaria().getConnection().prepareStatement("SELECT * FROM `users` WHERE (UUID=?)");
    ...
    public void createPlayer(Player player) {
        ...
        try (PreparedStatement statement = SupremeTags.getMaria().getConnection().prepareStatement(
    ...
    public static void setActive(OfflinePlayer player, String identifier) {
        ...
        try (PreparedStatement statement = SupremeTags.getMaria().getConnection().prepareStatement(sql)) {
    ...
    public static String getActive(UUID uuid) {
        ...
        try (PreparedStatement statement = SupremeTags.getMaria().getConnection().prepareStatement(query)) {
